    ...
    <>
      <aside className="w-56 flex-shrink-0 bg-white border-r border-gray-200/60 flex flex-col">
        ...
        <nav className="flex-1 overflow-auto py-3 px-3 scrollbar-thin">
          <p className="px-2 mb-2 text-[0.7rem] font-semibold text-slate-400 uppercase tracking-wider">
            반 목록
          </p>
          {classes.length === 0 && (
        ...
        <div className="p-3 border-t border-gray-100 space-y-1.5">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-[1rem] h-[1rem] flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"/><path d="M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z"/></svg>
            반 관리
          </button>
          <button
