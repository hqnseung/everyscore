      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="grid grid-cols-2 gap-0 divide-x divide-gray-100">
          ...
          <div className="px-6 py-4 space-y-4">
            <div>
              <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-2">화면</p>
              <div className="px-3 py-3 rounded-xl bg-gray-50 space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-slate-600">UI 크기</span>
                    <span className="text-xs font-semibold text-slate-400 tabular-nums">{Math.round(uiScale * 100)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.7"
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-slate-600">카드 글자 크기</span>
                    <span className="text-xs font-semibold text-slate-400 tabular-nums">{Math.round(fontScale * 100)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.5"
        ...
        <div className="px-6 py-3 border-t border-gray-100">
          <div className="text-sm text-slate-400 space-y-0.5">
            ...
            <p className="text-xs text-slate-300">Copyright © 2026 Han Seungwoo. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </div>
